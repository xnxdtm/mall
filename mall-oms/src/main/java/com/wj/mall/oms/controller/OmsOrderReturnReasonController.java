...
public class OmsOrderReturnReasonController {
     ...
     */
    @RequestMapping("/list")
    @RequiresPermissions("oms:omsorderreturnreason:list")
    ...
    @RequiresPermissions("oms:omsorderreturnreason:info")
     ...
     */
    @RequestMapping("/save")
    @RequiresPermissions("oms:omsorderreturnreason:save")
    ...
    @RequiresPermissions("oms:omsorderreturnreason:update")
    ...
    @RequiresPermissions("oms:omsorderreturnreason:delete")
