...
import com.wj.mall.oms.service.OmsRefundInfoService;
...
public class OmsRefundInfoController {
     ...
     */
    @RequestMapping("/list")
    @RequiresPermissions("oms:omsrefundinfo:list")
    ...
    @RequiresPermissions("oms:omsrefundinfo:info")
     ...
     */
    @RequestMapping("/save")
    @RequiresPermissions("oms:omsrefundinfo:save")
    ...
    @RequiresPermissions("oms:omsrefundinfo:update")
    ...
    @RequiresPermissions("oms:omsrefundinfo:delete")
