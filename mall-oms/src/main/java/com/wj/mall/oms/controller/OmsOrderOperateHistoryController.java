...
import com.wj.mall.oms.service.OmsOrderOperateHistoryService;
...
public class OmsOrderOperateHistoryController {
     ...
     */
    @RequestMapping("/list")
    @RequiresPermissions("oms:omsorderoperatehistory:list")
    ...
    @RequiresPermissions("oms:omsorderoperatehistory:info")
     ...
     */
    @RequestMapping("/save")
    @RequiresPermissions("oms:omsorderoperatehistory:save")
    ...
    @RequiresPermissions("oms:omsorderoperatehistory:update")
    ...
    @RequiresPermissions("oms:omsorderoperatehistory:delete")
