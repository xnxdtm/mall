...
import com.wj.mall.oms.service.OmsPaymentInfoService;
...
public class OmsPaymentInfoController {
     ...
     */
    @RequestMapping("/list")
    @RequiresPermissions("oms:omspaymentinfo:list")
    ...
    @RequiresPermissions("oms:omspaymentinfo:info")
     ...
     */
    @RequestMapping("/save")
    @RequiresPermissions("oms:omspaymentinfo:save")
    ...
    @RequiresPermissions("oms:omspaymentinfo:update")
    ...
    @RequiresPermissions("oms:omspaymentinfo:delete")
