...
public class WmsWareOrderTaskDetailController {
     ...
     */
    @RequestMapping("/list")
    @RequiresPermissions("wms:wmswareordertaskdetail:list")
    ...
    @RequiresPermissions("wms:wmswareordertaskdetail:info")
     ...
     */
    @RequestMapping("/save")
    @RequiresPermissions("wms:wmswareordertaskdetail:save")
    ...
    @RequiresPermissions("wms:wmswareordertaskdetail:update")
    ...
    @RequiresPermissions("wms:wmswareordertaskdetail:delete")
