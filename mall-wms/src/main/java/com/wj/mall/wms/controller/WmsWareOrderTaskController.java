...
import com.wj.mall.wms.service.WmsWareOrderTaskService;
...
public class WmsWareOrderTaskController {
     ...
     */
    @RequestMapping("/list")
    @RequiresPermissions("wms:wmswareordertask:list")
    ...
    @RequiresPermissions("wms:wmswareordertask:info")
     ...
     */
    @RequestMapping("/save")
    @RequiresPermissions("wms:wmswareordertask:save")
    ...
    @RequiresPermissions("wms:wmswareordertask:update")
    ...
    @RequiresPermissions("wms:wmswareordertask:delete")
